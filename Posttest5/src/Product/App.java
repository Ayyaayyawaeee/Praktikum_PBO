...
private  static void MenuGuest() throws IOException{
    ...
    private static void TambahCostume() throws IOException{
        System.out.print("Masukkan Nama Costume (Nama tidak dapat diganti, masukkan dengan benar) : ");
    ...
    private static void EditCostume() throws IOException {
        LihatCostume();
        while (true) { 
            System.out.println("Pilih Data yang Ingin Diedit (Tidak Dapat Mengedit nama)");
            int Nomor = cek_int() - 1;
